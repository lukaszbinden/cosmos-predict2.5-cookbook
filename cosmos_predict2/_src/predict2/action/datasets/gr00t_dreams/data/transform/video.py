...
from cosmos_predict2._src.predict2.action.datasets.gr00t_dreams.data.schema import DatasetMetadata
from cosmos_predict2._src.predict2.action.datasets.gr00t_dreams.data.transform.base import ModalityTransform
...
class VideoTransform(ModalityTransform):
    ...
    _INTERPOLATION_MAP: ClassVar[dict[str, dict[str, Any]]] = PrivateAttr(
        {
            ...
            "lanczos4": {
                ...
                "torchvision": T.InterpolationMode.LANCZOS,
                # Torchvision does not specify filter size, might be different from 4x4
            },
            "linear_exact": {
    ...
    def apply(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            raise ValueError(f"Input data does not match the expected format for {self.__class__.__name__}: {e}") from e
